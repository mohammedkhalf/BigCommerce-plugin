import type { GridedItemProps, GridedProps, TransientGridedItemProps, TransientGridedProps } from './types';
export declare const withGridedContainer: () => import("styled-components").RuleSet<NoInfer<Partial<{
...
export declare const withGridedItems: () => import("styled-components").RuleSet<NoInfer<Partial<{
...
export declare function toTransientGridedContainerProps(props: GridedProps): TransientGridedProps;
export declare function toTransientGridedItemProps(props: GridedItemProps): TransientGridedItemProps;
