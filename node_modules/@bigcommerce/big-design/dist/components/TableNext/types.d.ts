...
type StatelessPaginationPropsWithItemTotal = StatelessPaginationProps & {
    totalItems?: number;
};
export type DiscriminatedTablePaginationProps = (WithoutMarginProps<OffsetPaginationProps> & {
    type: 'offset';
}) | (WithoutMarginProps<StatelessPaginationPropsWithItemTotal> & {
    type: 'stateless';
});
export type TablePaginationProps = WithoutMarginProps<OffsetPaginationProps> | WithoutMarginProps<StatelessPaginationPropsWithItemTotal>;
