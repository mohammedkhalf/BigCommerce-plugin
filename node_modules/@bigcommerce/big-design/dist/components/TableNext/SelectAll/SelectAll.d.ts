...
import type { TableExpandable, TableItem, TablePaginationProps, TableProps, TableSelectable } from '../types';
...
export declare const SelectAll: <T extends TableItem>(props: SelectAllProps<T>) => React.JSX.Element;
