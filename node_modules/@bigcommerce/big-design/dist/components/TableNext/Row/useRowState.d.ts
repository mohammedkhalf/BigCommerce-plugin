...
export declare const useRowState: ({ isParentRow, isSelected, selectedItems, isChildrenRowsSelectable, childrenRowsIds, }: UseRowStateProps) => {
...
export {};
//# sourceMappingURL=useRowState.d.ts.map