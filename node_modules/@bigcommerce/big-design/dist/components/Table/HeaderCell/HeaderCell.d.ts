import React, { type ComponentPropsWithoutRef, type RefObject } from 'react';
...
export interface HeaderCellProps<T> extends ComponentPropsWithoutRef<'th'>, TableColumnDisplayProps {
