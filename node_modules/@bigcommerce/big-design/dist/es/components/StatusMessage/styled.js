...
export const StyledStatusMessage = /*#__PURE__*/styled.div.withConfig({
...
export const StyledStatusIllustration = /*#__PURE__*/styled.figure.withConfig({
  ...
  theme,
  $size
}) => $size === 'page' && css(["transform:scale(1.5);transform-origin:bottom;margin-block-start:", ";"], theme.helpers.remCalc(60)));
