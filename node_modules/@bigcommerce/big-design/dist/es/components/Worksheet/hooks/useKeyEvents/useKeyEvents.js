...
export const useKeyEvents = () => {
  ...
  const selectedCell = useStore(store, useShallow(state => state.selectedCells[0]));
  const lastSelectedCell = useStore(store, useShallow(state => state.selectedCells[state.selectedCells.length - 1]));
  ...
  const isEditing = useStore(store, useShallow(state => state.editingCell !== null));
  const isShiftPressed = useStore(store, useShallow(state => state.isShiftPressed));
  const setShiftPressed = useStore(store, useShallow(state => state.setShiftPressed));
