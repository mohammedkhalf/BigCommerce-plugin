...
exports.StyledStatusMessage = exports.StyledStatusIllustration = void 0;
...
const generateIllustration = variant => {
  const {
    icon,
    pattern,
    gradient
...
const StyledStatusMessage = exports.StyledStatusMessage = /*#__PURE__*/_styledComponents.default.div.withConfig({
  displayName: "styled__StyledStatusMessage",
  componentId: "sc-tkye6b-0"
})(["display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;"]);
StyledStatusMessage.defaultProps = {
  theme: _bigDesignTheme.theme
};
const StyledStatusIllustration = exports.StyledStatusIllustration = /*#__PURE__*/_styledComponents.default.figure.withConfig({
  displayName: "styled__StyledStatusIllustration",
  componentId: "sc-tkye6b-1"
})(["width:", ";height:", ";border-radius:50%;position:relative;overflow:hidden;margin:0;background-image:", ";content:'';", ""], ({
  theme
}) => theme.helpers.remCalc(120), ({
  theme
}) => theme.helpers.remCalc(120), ({
  $variant = 'info'
}) => generateIllustration($variant), ({
  theme,
  $size
}) => $size === 'page' && (0, _styledComponents.css)(["transform:scale(1.5);transform-origin:bottom;margin-block-start:", ";"], theme.helpers.remCalc(60)));
