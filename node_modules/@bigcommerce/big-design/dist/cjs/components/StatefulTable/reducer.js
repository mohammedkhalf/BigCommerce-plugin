...
exports.createReducerInit = exports.createReducer = void 0;
var _PillTabs = require("../PillTabs");
const createReducerInit = () => ({
  columns,
  defaultSelected,
  items,
  pagination
...
function getActivePills(pillTabs, activePills, pillId) {
  ...
  const flatItems = (0, _PillTabs.isPillTabItemGroupArray)(pillTabs) ? pillTabs.flatMap(group => group.items) : pillTabs;
