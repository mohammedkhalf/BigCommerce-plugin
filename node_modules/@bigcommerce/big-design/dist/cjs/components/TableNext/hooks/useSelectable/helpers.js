...
exports.getTotalSelectedChildRows = getTotalSelectedChildRows;
exports.selectChildRow = selectChildRow;
exports.selectParentRow = selectParentRow;
...
function unselectChild({
  ...
  const newSelectedItems = Object.entries(selectedItems).filter(([key]) => key !== `${childRowId}`).filter(([key]) => {
...
function getTotalSelectedChildRows({
  selectedItems,
  childrenRowsIds
}) {
