...
exports.toTransientGridedContainerProps = toTransientGridedContainerProps;
exports.toTransientGridedItemProps = toTransientGridedItemProps;
exports.withGridedItems = exports.withGridedContainer = void 0;
var _bigDesignTheme = require("@bigcommerce/big-design-theme");
var _styledComponents = require("styled-components");
const withGridedContainer = () => (0, _styledComponents.css)(["", ";", ";", ";", ";", ";", ";", ";", ";", ";", ";"], ({
  $gridAreas,
  theme
  ...
  $gridGap,
  theme
}) => getGridedStyles($gridGap ?? theme.spacing.medium, theme, 'gap'), ({
  $gridColumnGap,
  theme
}) => $gridColumnGap && getGridedStyles($gridColumnGap, theme, 'column-gap'), ({
  $gridRows,
  theme
}) => $gridRows && getGridedStyles($gridRows, theme, 'grid-template-rows'), ({
  $gridRowGap,
  theme
}) => $gridRowGap && getGridedStyles($gridRowGap, theme, 'row-gap'), ({
  $gridTemplate,
  theme
}) => $gridTemplate && getGridedStyles($gridTemplate, theme, 'grid-template'));
exports.withGridedContainer = withGridedContainer;
const withGridedItems = () => (0, _styledComponents.css)(["", ";", ";", ";", ";", ";", ";", ";"], ({
  $gridArea,
  theme
}) => $gridArea && getGridedStyles($gridArea, theme, 'grid-area'), ({
  $gridColumn,
  theme
}) => $gridColumn && getGridedStyles($gridColumn, theme, 'grid-column'), ({
  $gridColumnEnd,
  theme
  ...
  $gridRow,
  theme
}) => $gridRow && getGridedStyles($gridRow, theme, 'grid-row'), ({
  $gridRowEnd,
  theme
}) => $gridRowEnd && getGridedStyles($gridRowEnd, theme, 'grid-row-end'), ({
  $gridRowStart,
  theme
}) => $gridRowStart && getGridedStyles($gridRowStart, theme, 'grid-row-start'));
exports.withGridedItems = withGridedItems;
function toTransientGridedContainerProps(props) {
  const {
    gridAreas,
    gridAutoColumns,
    gridAutoFlow,
...
function toTransientGridedItemProps(props) {
  const {
    gridArea,
    gridColumn,
    gridColumnEnd,
...
const getResponsiveGrid = (gridedProp, theme, cssKey) => {
  ...
  // eslint-disable-next-line @typescript-eslint/consistent-type-assertions
  return breakpointKeys.map(breakpointKey => (0, _styledComponents.css)(["", "{", " ", "}"], theme.breakpoints[breakpointKey], '', getSimpleGrid(gridedProp[breakpointKey], cssKey)));
};