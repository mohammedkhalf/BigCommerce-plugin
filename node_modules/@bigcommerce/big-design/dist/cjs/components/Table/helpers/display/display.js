...
const withTableColumnDisplay = () => (0, _styledComponents.css)(["", ";"], ({
  $display,
  theme
}) => $display && getDisplayStyles($display, theme, 'display'));
...
const getResponsiveDisplay = (displayProp, theme, cssKey) => {
  ...
  // eslint-disable-next-line @typescript-eslint/consistent-type-assertions
  return breakpointKeys.map(breakpointKey => (0, _styledComponents.css)(["", "{", " ", "}"], theme.breakpoints[breakpointKey], '', getSimpleDisplay(displayProp[breakpointKey], cssKey)));
};