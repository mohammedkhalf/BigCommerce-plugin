...
function getSpacingStyles(spacing, theme, ...spacingKeys) {
...
function getResponsiveSpacings(responsiveSpacing, theme, spacingKeys) {
  ...
  _bigDesignTheme.breakpointsOrder.indexOf(a) -
  // eslint-disable-next-line @typescript-eslint/consistent-type-assertions
  _bigDesignTheme.breakpointsOrder.indexOf(b));

  // eslint-disable-next-line @typescript-eslint/consistent-type-assertions
  return breakpointKeys.map(breakpointKey => (0, _styledComponents.css)(["", "{", "}"], theme.breakpoints[breakpointKey], getSimpleSpacings(
  // eslint-disable-next-line @typescript-eslint/consistent-type-assertions
