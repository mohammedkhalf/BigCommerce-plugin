...
const createSpacing = () => ({
  ...
  xxSmallN: `-${(0, _helpers.remCalc)(4)}`,
  xSmallN: `-${(0, _helpers.remCalc)(8)}`,
  smallN: `-${(0, _helpers.remCalc)(12)}`,
  mediumN: `-${(0, _helpers.remCalc)(16)}`,
  largeN: `-${(0, _helpers.remCalc)(20)}`,
  xLargeN: `-${(0, _helpers.remCalc)(24)}`,
  xxLargeN: `-${(0, _helpers.remCalc)(32)}`,
  xxxLargeN: `-${(0, _helpers.remCalc)(48)}`
});
