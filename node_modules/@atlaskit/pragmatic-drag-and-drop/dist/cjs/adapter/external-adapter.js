...
var _getAvailableItems = require("./get-available-items");
var _getAvailableTypes = require("./get-available-types");
var _isAnAvailableType = require("./is-an-available-type");
  ...
  mount: function mount(api) {
    ...
    return (0, _bindEventListener.bind)(window, {
      ...
      listener: function listener(event) {
        ...
        var types = (0, _getAvailableTypes.getAvailableTypes)(event.dataTransfer);
        if (!types.length) {
          return;
        }
        var locked = {
        ...
        api.start({
          ...
          dragType: {
            ...
            getDropPayload: function getDropPayload(event) {
              ...
              var items = (0, _getAvailableItems.getAvailableItems)(event.dataTransfer);
              ...
              return {
                ...
                getStringData: function getStringData(mediaType) {
                  ...
                  if (!(0, _isAnAvailableType.isAnAvailableType)({
                    type: mediaType,
                    value: value
                  })) {
                    return null;
